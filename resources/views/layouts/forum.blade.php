...
<head>
    ...
    <title>EP N°33</title>
    <link rel="icon" href="{{ asset('images/ep33.jpg') }}" type="image/jpeg">
    <link rel="shortcut icon" href="{{ asset('images/ep33.jpg') }}" type="image/jpeg">
    <style>
        :root {
            color-scheme: light;
            --bg: #f7efe5;
        ...
        * { box-sizing: border-box; }
        ...
        .tutorial-card { padding: 1.5rem 1.5rem; min-height: 260px; display:flex; flex-direction:column; gap:1rem; }
        .tutorial-header { display:grid; grid-template-columns: 1fr auto; gap: 1rem; align-items: flex-start; width:100%; }
        .tutorial-header h1 { margin:0 0 0.75rem; }
        .tutorial-header ul { margin: 0; padding-left: 1.25rem; }
        .tutorial-header li { margin-bottom: 0.75rem; line-height: 1.7; }
        .tutorial-actions { display:flex; justify-content:flex-end; align-items:flex-start; }
        .tutorial-video-section { display:none; margin-top: 1.25rem; width:100%; }
        .tutorial-video-section.active { display:block; }
        .tutorial-video { width: 100%; max-width: 100%; height: auto; min-height: 240px; max-height: 540px; border-radius: 18px; box-shadow: 0 18px 40px rgba(0,0,0,0.16); background:#000; }
        .tutorial-close-action { display:flex; justify-content:flex-end; margin-top: 1rem; }

        @media (max-width: 860px) {
            .tutorial-card { min-height: auto; }
            .tutorial-header { grid-template-columns: 1fr; }
            .tutorial-actions { justify-content:center; }
            .tutorial-video-section { margin-top: 1rem; }
        }
        ...
        .hero-repelentes .flip-card-inner { min-height: 660px; }
        .hero-repelentes .flip-front { justify-content: space-between; }
        .video-container { width: 100%; max-width: 860px; margin: 0 auto; display:flex; justify-content:center; }
        .tutorial-video { width: 100%; height: auto; max-height: 520px; border-radius: 14px; background: #000; }
        ...
        @media (max-width: 580px) {
            ...
            .lightbox .lightbox-content { width: 100%; height: 100%; }
            .lightbox img,
            .lightbox video { max-width: 100%; max-height: calc(100vh - 1.5rem); width: 100%; }
            .lightbox video { height: auto; }
            .lightbox-close,
